...
class LyreFacetServiceProvider extends ServiceProvider
{
    ...
    public function registerRepositories($app)
    {
        ...
        foreach ($iterator as $file) {
            ...
            $interfaceNamespace = 'Lyre\\Facet\\Repositories\\Contracts\\' . $namespacePath . 'Interface';
            $implementationNamespace = 'Lyre\\Facet\\Repositories\\' . $namespacePath;
    ...
    private static function registerGlobalObserver()
    {
        ...
        $modelsBaseNamespace = "Lyre\\Facet\\Models";
